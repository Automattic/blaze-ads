<?php
/**
 * Class Blaze_Compat_Dashboard_Test
 *
...
use WooBlaze\Blaze_Compat_Dashboard;
 ...
 */
class Blaze_Compat_Dashboard_Test extends WB_Unit_Test_Case {
	/**
	 * Test has root dom.
	 *
	 * @covers WooBlaze\Blaze_Compat_Dashboard::render
	 */
	public function test_render() {
		$this->expectOutputRegex( '/<div id="wpcom" class="woo-blaze-dashboard".*>/i' );
		( new Blaze_Compat_Dashboard() )->render();
	}

	/**
	 * Ensure the script can be enqueued in admin.
	 *
	 * @covers WooBlaze\Blaze_Compat_Dashboard::admin_init
	 */
	public function test_admin_init() {
		( new Blaze_Compat_Dashboard() )->admin_init();
	 ...
	 *
	 * @covers WooBlaze\Blaze_Compat_Dashboard::load_admin_scripts
	 */
	public function test_load_admin_scripts() {
		$script_handle = Blaze_Compat_Dashboard::SCRIPT_HANDLE;
		$style_handle  = $script_handle . '-style';

		// Scripts and style should not be enqueued on the main dashboard.
		( new Blaze_Compat_Dashboard() )->load_admin_scripts( 'index.php' );
		...
		( new Blaze_Compat_Dashboard() )->load_admin_scripts( 'marketing_page_wc-blaze' );
