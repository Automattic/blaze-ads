...
if [[ -n "$CHANGELOG_FILES" ]]; then
	...
	echo "Add at least one changelog file for your PR by running: pnpm changelog"
	...
	echo "Remove changelog in changelog.txt if you have already added them in your PR."
	exit 1
fi
