...
class Blaze_Compat_Dashboard {
	...
	public function load_admin_scripts( $hook ) {
		...
		$dashboard_config = new Blaze_Compat_Dashboard_Config_Data();
		$config_data      = ( new Blaze_Dashboard() )->woo_blaze_initial_config_data( $dashboard_config->get_data() );
